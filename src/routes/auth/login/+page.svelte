	...
	>
		...
		<label class="input input-bordered flex items-center gap-2">
			...
			<input
				...
				class="grow input"
				placeholder="Email"
				class:input-error={errorsLogin.email}
			/>
		</label>
		...
		<label class="input input-bordered flex items-center gap-2">
			...
			<input
				...
				name="password"
				class="grow input"
				class:input-error={errorsLogin.password}
				placeholder="*******"
			/>
			<button
				type="button"
				on:click={() =>
					typePassword === 'password' ? (typePassword = 'text') : (typePassword = 'password')}
			>
	...
	>
		...
		<label class="input input-bordered flex items-center gap-2">
			...
			<input
				...
				class="grow input"
				placeholder="Email"
				class:input-error={errorsRegister.email}
			/>
		</label>
		...
		<label class="input input-bordered flex items-center gap-2">
			...
			<input
				...
				class="grow input"
				placeholder="*******"
				class:input-error={errorsRegister.password}
			/>
